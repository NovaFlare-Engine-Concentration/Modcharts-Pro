...
class SustainRenderer extends FlxStrip
{
    ...
    public function constructVertices(noteData:NoteTransformData, thisNotePos:Vector3D, nextHalfNotePos:NoteTransformData, nextNotePos:NoteTransformData, flipGraphic:Bool, reverseClip:Bool)
    {
