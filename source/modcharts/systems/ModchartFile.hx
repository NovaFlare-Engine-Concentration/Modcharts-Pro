...
class ModchartFile
{
    ...
    private var renderer:PlayfieldSystem;
    ...
    public function new(renderer:PlayfieldSystem)
    {
    ...
    public function loadModifiers()
    {
        ...
        {
            ModchartActions.startMod(i[MOD_NAME], i[MOD_CLASS], i[MOD_TYPE], Std.parseInt(i[MOD_PF]), renderer.instance);
            if (i[MOD_LANE] != null)
    ...
    private function addEvent(i:Array<Dynamic>, ?beatOffset:Float = 0)
    {
        ...
        {
            case "ease":
                ModchartActions.ease(Std.parseFloat(i[EVENT_DATA][EVENT_TIME])+beatOffset, Std.parseFloat(i[EVENT_DATA][EVENT_EASETIME]), i[EVENT_DATA][EVENT_EASE], i[EVENT_DATA][EVENT_EASEDATA], renderer.instance);
            case "set":
                ModchartActions.set(Std.parseFloat(i[EVENT_DATA][EVENT_TIME])+beatOffset, i[EVENT_DATA][EVENT_SETDATA], renderer.instance);
            case "hscript":
...
class CustomModifierScript
{
    ...
    private function init()
    {
        ...
        interp.variables.set('PlayfieldSystem', PlayfieldSystem);
        interp.variables.set('ModchartHelper', ModchartHelper);
        ...
        interp.variables.set('NoteTransform', NoteTransform);
        interp.variables.set('NoteTransformData', NoteTransformData);
