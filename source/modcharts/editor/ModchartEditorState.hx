...
import modcharts.engine.PlayfieldRenderer.StrumNoteType;
...
class ModchartEditorState extends MusicBeatState
{
    ...
    public static var modifierList:Array<Class<Modifier>> = [
        modcharts.modifiers.DrunkXModifier, modcharts.modifiers.DrunkYModifier, modcharts.modifiers.DrunkZModifier,
        modcharts.modifiers.TipsyXModifier, modcharts.modifiers.TipsyYModifier, modcharts.modifiers.TipsyZModifier,
        modcharts.modifiers.ReverseModifier, modcharts.modifiers.IncomingAngleModifier, modcharts.modifiers.RotateModifier, modcharts.modifiers.StrumLineRotateModifier,
        modcharts.modifiers.BumpyModifier,
        modcharts.modifiers.XModifier, modcharts.modifiers.YModifier, modcharts.modifiers.ZModifier, modcharts.modifiers.ConfusionModifier, 
        modcharts.modifiers.ScaleModifier, modcharts.modifiers.ScaleXModifier, modcharts.modifiers.ScaleYModifier, modcharts.modifiers.SpeedModifier, 
        modcharts.modifiers.StealthModifier, modcharts.modifiers.NoteStealthModifier, modcharts.modifiers.InvertModifier, modcharts.modifiers.FlipModifier, 
        modcharts.modifiers.MiniModifier, modcharts.modifiers.ShrinkModifier, modcharts.modifiers.BeatXModifier, modcharts.modifiers.BeatYModifier, modcharts.modifiers.BeatZModifier, 
        modcharts.modifiers.BounceXModifier, modcharts.modifiers.BounceYModifier, modcharts.modifiers.BounceZModifier, 
        modcharts.modifiers.EaseCurveModifier, modcharts.modifiers.EaseCurveXModifier, modcharts.modifiers.EaseCurveYModifier, modcharts.modifiers.EaseCurveZModifier, modcharts.modifiers.EaseCurveAngleModifier,
        modcharts.modifiers.InvertSineModifier, modcharts.modifiers.BoostModifier, modcharts.modifiers.BrakeModifier, modcharts.modifiers.JumpModifier
    ];
    ...
    function setupModifierUI()
    {
        ...
        {
            modClassList.push(Std.string(modifierList[i]).replace("modcharts.modifiers.", ""));
        }
